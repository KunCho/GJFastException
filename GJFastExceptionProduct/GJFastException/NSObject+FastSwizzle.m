...
@implementation NSObject (AKSwizzle)
...
+ (BOOL)fastSwizzleClassMethod:(SEL)origSel_ withClassMethod:(SEL)altSel_ error:(NSError **)error_ {
    return [GetClass((id)self) fastSwizzleMethod:origSel_ withMethod:altSel_ error:error_];
}
@end


@implementation NSObject (KVCProtection)
